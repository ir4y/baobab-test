...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baobab = __webpack_require__(159);
	...
	var App = _react2['default'].createClass({
	    ...
	    onDelete: function onDelete() {
	        this.itemList.apply(function (lst) {
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(EditForm, {
	                ...
	                tree: this.editForm }),
	            _react2['default'].createElement(ItemList, { cursor: this.itemList })
	        );
	    }
	});
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(Input, { cursor: this.name })
	            ),
	            _react2['default'].createElement(
	                'p',
	                null,
	                ...
	                _react2['default'].createElement(Input, { cursor: this.externalId })
	            ),
	            _react2['default'].createElement(
	                'button',
	                { onClick: this.onAdd },
	...
	function Input(_ref) {
	    ...
	    var onChange = function onChange(e) {
	        return cursor.set(e.target.value);
	    };
	    return _react2['default'].createElement('input', { value: cursor.get(), onChange: onChange });
	}
	...
	function ItemList(_ref2) {
	    ...
	    return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	            'tbody',
	            null,
	            cursor.get().map(function (item, index) {
	                return _react2['default'].createElement(Item, { key: index, tree: cursor.select(index) });
	            })
	        )
	    );
	}
	...
	var Item = _react2['default'].createClass({
	    ...
	    onClick: function onClick() {
	        this.selected.apply(function (c) {
	            return !c;
	        });
	    },
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'td',
	                null,
	                _react2['default'].createElement('input', { onChange: this.onClick, checked: this.selected.get(), type: 'checkbox' })
	            ),
	            _react2['default'].createElement(
	                'td',
	                null,
	...
	(0, _reactDom.render)(_react2['default'].createElement(App, null), document.getElementById('react-view'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _emmett = __webpack_require__(160);
	...
	var _monkey = __webpack_require__(162);

	var _watcher = __webpack_require__(166);
	...
	var _update2 = __webpack_require__(164);
